...
public class House extends Services {
    ...
    public House(String id, String serviceName, double areaOfUse, int rentalCosts, int numberOfPeopleMax, String rentType, String standardRoom, String comfortDescription, int numberOfFloors) {
